    ...
    >
      <div className="w-full max-w-sm">
        <div className="flex flex-col items-center gap-3 mb-8">
          ...
          <h1 className="text-xl font-medium text-navy text-center" style={{ letterSpacing: '-0.2px' }}>Welcome back</h1>
          <p className="text-sm text-subtle text-center">Log in to your DashPlot account</p>
        </div>
        ...
        <div className="bg-white rounded-card border border-mint shadow-card p-6 sm:p-8">
          <form onSubmit={handleSubmit} className="flex flex-col gap-4">
            ...
            <div className="flex flex-col gap-1.5">
              <div className="flex items-center justify-between">
                ...
                <Link to="/forgot-password" className="text-xs text-subtle hover:text-teal transition-colors">Forgot password?</Link>
              </div>
          ...
          <p className="text-xs text-subtle text-center mt-6">
            ...
            <Link to="/signup" className="text-teal hover:underline">Start free trial</Link>
          </p>
        </div>
      </div>
    </div>
